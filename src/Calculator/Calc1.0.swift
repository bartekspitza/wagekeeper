...
//    
//    let statsDescs = ["AVERAGE SHIFT LENGTH", "TOTAL DAYS WORKED", "TOTAL SHIFTS", "OVERTIME WORKED"]
//    var statsInfo = [String]()
//    // Other variables
//    var period = Period(date: "", salary: "", grossSalary: "0", totalHours: [Any](), shiftsWorked: "", avgShift: "", currency: "")
...
//        period = Period(date: "", salary: "0", grossSalary: "0", totalHours: [Any](), shiftsWorked: "", avgShift: "", currency: "")
//        appStarted = false
//        statsInfo.removeAll()
//        fillTable()
//        makePeriod()
...
//            UserDefaults().set("0", forKey: "wageRate")
//        }
//        // CURRENCY
...
//            UserDefaults().set("Example", forKey: "defaultNote")
//        }
//        // Lunch
...
//                periodLbl.sizeToFit()
//                periodLbl.frame = CGRect(x: 0, y: 0, width: Int(periodLbl.frame.width + 1), height: Int(periodLbl.frame.height))
...
//                if symbol == "kr" {
//                    salaryLbl.text = "0KR"
//                    grossLbl.text = "PRETAX: 0KR"
//                } else {
//                    salaryLbl.text = symbol + "0"
//                    grossLbl.text = "PRETAX: " + symbol + "0"
//                }
//            }
//        }
//    }
...
//        self.view.addSubview(seperatorLineHorizontal)
//        self.view.addSubview(seperatorLineVertical)
...
//
//        salaryLbl.frame = CGRect(x: 0, y: 0, width: Int(self.view.frame.width/3), height: Int(gradientMaxY/3))
//        salaryLbl.font = UIFont.systemFont(ofSize: 35)
//        salaryLbl.text = salaryLbl.text?.uppercased()
//        salaryLbl.center = CGPoint(x: Int(self.view.frame.width/2), y: Int(self.view.frame.height*0.4 * 0.75 * 0.5))
...
//        grossLbl.center = CGPoint(x: Int(self.view.frame.width/4), y: Int(seperatorLineHorizontal.center.y))
...
//        totalHoursLbl.center = CGPoint(x: Int(self.view.frame.width/2 - totalHoursLbl.frame.width/2 - 3 + 85), y: Int(seperatorLineHorizontal.center.y))
...
//        totalMinutesLbl.center = CGPoint(x: Int(self.view.frame.width/2 + totalMinutesLbl.frame.width/2 + 3 + 85), y: Int(seperatorLineHorizontal.center.y))
//        totalMinutesLbl.font = UIFont.systemFont(ofSize: 13)
//        
//        periodLbl.textColor = .white
//        //periodLbl.frame = CGRect(x: 0, y: 0, width: Int(self.view.frame.width/2), height: Int(30))
...
//        self.view.addSubview(totalHoursLbl)
//        self.view.addSubview(totalMinutesLbl)
//        self.view.addSubview(seperatorLineHorizontal)
//    }
//    
...
//            }
//            if (period.totalHours[0] as! Int) > 0 {
//                totalMinutesLbl.count(fromValue: 0, to: Float(period.totalHours[1] as! Int), withDuration: 1, andAnimationtype: .Linear, andCounterType: .Int, currency: "", preString: "", afterString: " " + (period.totalHours[3] as! String).uppercased())
//                totalHoursLbl.count(fromValue: 0, to: Float(period.totalHours[0] as! Int), withDuration: 1, andAnimationtype: .Linear, andCounterType: .Int, currency: "", preString: "", afterString: " " + (period.totalHours[2] as! String).uppercased())
//            }
//        }
//        
//    }
...
//        remainingMinutes = (Float(calcHours(day: shift)[1])) + (Float(calcHours(day: shift)[0]) * 60)
...
//    }
//    
//    func calculateTotalHours(month: [Shift]) -> [Any] {
//        var hoursFormat = ""
//        var minutesFormat = ""
//        var hoursWorked = 0
//        var minutesWorked = 0
...
//        }
//        
//        return [hoursWorked, minutesWorked, hoursFormat, minutesFormat]
//    }
//    
